...
class Slide {
  ...
  touchEnd(e) {
    ...
    //  div.innerHTML = (
    //   `
    //   <p style='width:100%;word-break:break-all;'>上次的：${JSON.stringify(prevTouches)}</p>
    //   <p style='width:100%;word-break:break-all;'>这次的：${JSON.stringify(currentExactTouches)}</p>
    //   <p style='width:100%;word-break:break-all;'>上次的：${JSON.stringify(this.touchMap)}</p>
    //   <p style='width:100%;word-break:break-all;'>这次的：${JSON.stringify(newMap)}</p>
    //   `
    // )
    // 更新后的触点
